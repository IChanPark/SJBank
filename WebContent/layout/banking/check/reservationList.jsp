...
Gson gson = new Gson();
String json ="[";
ArrayList<Transfer_reserveDTO> dto = 
Transfer_reserveDAO.getInstance().SearchDate(request.getParameter("start")
...
for (int i = 0; i < dto.size(); i++) {
	...
	map.put("time", dto.get(i).getTime());
	map.put("memo", dto.get(i).getTime());
	map.put("to_memo", dto.get(i).getTime());
