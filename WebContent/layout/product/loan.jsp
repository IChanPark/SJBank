...
var selected_Product = "대출";
var selected_Type = "";
var path = "product/loan/";
...
function option(){
	$.ajax({	
		url:"layout/product/loan_type.jsp",
		type:'post',
...
function ajax_go() {
	...
	success:function(qqq){
		...
		$.each(qqq,function(i,e){
			...
			row +="<div class='l'>"+"최저 연이자 "+"<br>"+e.min_interest+"</div>";
...
function detail(me) {
	...
	$.ajax({	
		...
		success:function(qqq){
			...
			/* box +=	"<div class='infoTop_Info'><div class='infoTop_Type'>상환기간</div>";
			var month = '';
			...
			box +=	"<div class='infoTop_Info'><div class='infoTop_Type'>상환 기간</div>"+qqq.month+" 개월"+"</div>";
			box +=	"<div class='infoTop_Info'><div class='infoTop_Type'>최저 연이자</div>"+qqq.min_interest+"</div>";
			box +=	"<div class='infoTop_Info'><div class='infoTop_Type'>최고 연이자</div>"+qqq.max_interest+"</div>";
			box +=	"</div>";
			...
			box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>대출 만기</div><div class='infoMain_Value'>"+qqq.month+" 개월"+"</div></div>";
			box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>대출 한도</div><div class='infoMain_Value'>["+qqq.loanlimit+" 원]</div></div>";	
...
function join(me) {
	...
	$.ajax({	
		...
		success:function(qqq){
			...
			box +=	"<div class='join_Guide'>입금정보</div>";
			box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>입금계좌번호</div><div class='infoMain_Value'>";
			...
			//box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>상환기간</div>";
			//box +=	"<div class='infoMain_Value' data-join-type='"+qqq.month+"'>"+qqq.month+"</div></div>"; 
			...
			//box +=	"<div class='infoMain_Value data-join-interest_type='"+qqq.interest_type+"''>"+qqq.interest_type+"</div></div>";
			 box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>대출기간</div>";
			box +=	"<div class='infoMain_Value'><select id='month'>"
			$.each(qqq.month.split('#'),function(i,e){
				box +=	"<option value='"+e+"'>"+e+"개월</option>";
			});
			box	+=	"</select></div></div>"; 
			box +=	"<div class='infoMain_Info'><div class='infoMain_Type'>대출금액</div>";
			box +=	"<div class='infoTop_Info'><div class='infoTop_Type'>  대출한도</div>"+qqq.loanlimit+" 원"+"</div>";
