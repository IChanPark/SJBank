...
주요서비스
<div>
<div style=" float: left; width: 30%; " id="check">즉시이체</div>
<div style=" float: left; width: 30%; ">전체조회</div>
<div style=" float: left; width: 30%; ">예약이체</div>
</div></div>
<div  align ="top" style="  height: auto; min-height : 100px; width :50%; background-color : #2EFEF7; float: left;"  align = "left"><h1>금융상품</h1></div>
