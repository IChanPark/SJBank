...
System.out.println("statu statusid"+request.getParameter("statusid"));
System.out.println("statu type"+request.getParameter("type"));

UserDAO.getInstance().changeStatus(request.getParameter("type"),request.getParameter("statusid"));
