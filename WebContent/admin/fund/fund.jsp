...
function detail(me) {
	...
	$.ajax({	
		...
		success:function(qqq){
			...
			box +=	"</div>";
			box +=	"<div class='infoBot'><div class='infoBot_Back' onclick='goMenu(this)' data-menu-name='admin/Fund/Fund'>목록으로</div></div>";
			box +=	"</div>";
			$("#mm").append(box);
			isRun = false;
		},
...
function add(){
	...
	box +=  "<select id='sector'><option value='보통위험'>보통위험</option><option value='고위험'>고위험</option></select>투자지역을 선택해주세요.</div></div>";
	box +=  "</div><div class='AdminBot'><div class='AdminButton' onclick='goMenu(this)' data-menu-name='admin/Fund/Fund'>상품등록취소</div>";
...
function addReg(){
	...
	gogo =  "admin/fund/fund_add_reg.jsp";
	$.ajax({	
		url:gogo,
		type:'post',
		data:{
...
function modify(me) {
	...
	$.ajax({	
		...
		success:function(qqq){
			...
			box +=  "</div><div class='AdminBot'><div class='AdminButton' onclick='goMenu(this)' data-menu-name='admin/Fund/Fund'>수정취소</div>";
			box +=  "<div class='AdminButton' onclick='modReg()' data-menu-name='admin/Fund/Fund'>수정등록</div></div></div>";
			$("#mm").append(box);
			isRun = false;
		},
		error:function(qqq){
...
function modReg(){
	...
	gogo =  "admin/fund/fund_mod_reg.jsp";
	$.ajax({	
		url:gogo,
		type:'post',
