...
function detail(me) {
   ...
   $.ajax({   
      ...
      success:function(qqq){
         ...
         box +=   "</div></div>";
         box +=   "</div>";
         box +=   "<div class='infoBot'><div class='infoBot_Back' onclick='goMenu(this)' data-menu-name='admin/Saving/Saving'>목록으로</div></div>";
         box +=   "</div>";
         $("#mm").append(box);
         isRun = false;
      },
...
function add(){
   ...
   box +=  "</div><div class='AdminBot'><div class='AdminButton' onclick='goMenu(this)' data-menu-name='admin/Saving/Saving'>상품등록취소</div>";
...
function addReg(){
   ...
   gogo =  "admin/saving/saving_add_reg.jsp";
   $.ajax({   
      url:gogo,
      type:'post',
      data:{   
...
function modify(me) {
   ...
   $.ajax({   
      ...
      success:function(qqq){
         ...
         box +=  "</div><div class='AdminBot'><div class='AdminButton' onclick='goMenu(this)' data-menu-name='admin/Saving/Saving'>수정취소</div>";
...
function modReg(){
   ...
   gogo =  "admin/saving/saving_mod_reg.jsp";
   $.ajax({   
      url:gogo,
      type:'post',
      data:{   
