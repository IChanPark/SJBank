...
-- 테이블 데이터 bank.menu:~100 rows (대략적) 내보내기
...
INSERT INTO `menu` (`type`, `name`, `kor_name`, `prnts_name`, `status`, `depth`, `sort`) VALUES
	...
	('security', 'blockalarm', '보안차단/알림서비스', 'security', '', 1, 3),
	...
	('usermanagement', 'holdcheck', '계좌정지 신청/조회', 'intbank', '', 2, 5),
	('usermanagement', 'limitred', '이체한도감액', 'intbank', '', 2, 4),
	('usermanagement', 'unuserel', '장기미사용정지 해제', 'intbank', '', 2, 3),
	('usermanagement', 'bagreement', '(은행)개인(신용)정보수집-이용제공동의', 'info', '', 2, 2),
	...
	('usermanagement', 'cashier', '자기앞수표', 'report', '', 2, 1),
	('usermanagement', 'scotp', 'otp', 'report', '', 2, 0),
