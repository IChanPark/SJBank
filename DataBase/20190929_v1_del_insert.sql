...
-- 테이블 데이터 bank.deposits_info:~1 rows (대략적) 내보내기
...
INSERT INTO `transfer_log` (`seq`, `account_number`, `self`, `target`, `to_account_number`, `received`, `sum`, `fee`, `cms`, `memo`, `to_memo`, `status`, `register_date`) VALUES
	(1, '101-1112-112-1232', 'y', '하나은행', '111-1234-5678', '갓이찬', 1234560, NULL, NULL, '팀플금액청구', NULL, NULL, NULL);
...
-- 테이블 데이터 bank.user:~5 rows (대략적) 내보내기
