...
INSERT INTO `deposits_info` (`product`, `min_interest`, `max_interest`, `month`, `type`, `jnterest_type`, `tax`, `preferential`, `prf_content`, `prf_interest`, `min_sum`, `max_sum`, `partialization`, `retention`, `status`, `register_date`, `end_date`) VALUES
...
-- 테이블 데이터 bank.membersheep_rating:~4 rows (대략적) 내보내기
...
INSERT INTO `menu` (`type`, `name`, `kor_name`, `prnts_name`, `status`, `depth`, `sort`) VALUES
	...
	('management', 'bbcc', '통장메모내용변경', 'accmanag', 'y', 2, 5),
	...
	('management', 'deposit', '자주쓰는입금계좌관리', 'accmanag', 'y', 2, 2),
	...
	('management', 'holdcheck', '계좌정지 등록 · 관리', 'intbank', 'y', 2, 5),
	...
	('management', 'limitred', '이체한도관리', 'intbank', 'y', 2, 4),
...
INSERT INTO `otp` (`serial`, `id`, `type`, `status`, `register_date`, `end_date`) VALUES
	('123-1234-1234', 'elliottjo', '휴대폰OTP', '정상', '2019-09-30 15:45:57', '2022-02-22 00:00:00');
...
-- 테이블 데이터 bank.saving_type:~2 rows (대략적) 내보내기
...
-- 테이블 데이터 bank.user:~6 rows (대략적) 내보내기
...
INSERT INTO `user` (`id`, `pw`, `simple_pw`, `name`, `tel`, `gen`, `email`, `job_group`, `addr`, `postal_code`, `status`, `register_date`, `end_date`) VALUES
	...
	('day_0821', '1111', 0, '박이찬', '010-####-#', '남', 'asd@naver.com', '학생', 'addas', 123, '활성', '2019-09-05 08:31:36', NULL),
...
-- 테이블 데이터 bank.user_login_log:~1 rows (대략적) 내보내기
